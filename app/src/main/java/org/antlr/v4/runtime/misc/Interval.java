...
public class Interval implements Parcelable {
  public static final Parcelable.Creator<IntervalSet> CREATOR = new Parcelable.Creator<IntervalSet>(){

    @Override
    public IntervalSet createFromParcel(Parcel p1) {
      int a = p1.readInt();
      int b = p1.readInt();
      return new IntervalSet(a, b);
    }

    @Override
    public IntervalSet[] newArray(int p1) {
      return new IntervalSet[p1];
    }
  };
