...
public class UnbufferedTokenStream<T extends Token> implements TokenStream {
	...
	public UnbufferedTokenStream(Scanner scanner) {
		this(scanner, 256);
	}

	public UnbufferedTokenStream(Scanner tokenSource, int bufferSize) {
